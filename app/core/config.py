...
Minimal environment settings fallback (no pydantic required).
"""
...
class Settings:
    ...
    secret_key: str = os.getenv("SECRET_KEY", "change-me-in-production-use-secrets")
    database_url: str = os.getenv("DATABASE_URL", "sqlite+aiosqlite:///./semptify.db")
...
"""
    ...
    # ==========================================================================
    # Security Mode: Always enforced - production only
    # ==========================================================================
